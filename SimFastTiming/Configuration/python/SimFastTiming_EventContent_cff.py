...
_phase2_timing_extraCommands = cms.PSet( # using PSet in order to customize with Modifier
    value = cms.vstring( 'keep *_mix_FTLBarrel_*','keep *_mix_FTLBarrelSoA_*','keep *_mix_FTLEndcap_*','keep *_mix_FTLEndcapSoA_*','keep *_mix_InitialVertices_*', 'keep *_mtdRecoClusterToSimLayerClusterAssociation_*_*', 'keep *_mtdSimLayerClusterToTPAssociation_*_*')
)
...
premix_stage2.toModify(_phase2_timing_extraCommands,
    value = [ 'keep *_mixData_FTLBarrel_*','keep *_mixData_FTLBarrelSoA_*','keep *_mixData_FTLEndcap_*','keep *_mix_FTLEndcapSoA_*','keep *_mix_InitialVertices_*', 'keep *_mtdRecoClusterToSimLayerClusterAssociation_*_*', 'keep *_mtdSimLayerClusterToTPAssociation_*_*' ]
)
