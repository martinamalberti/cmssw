...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        # SingleMu, noPU        
        'file:/afs/cern.ch/work/m/malberti/MTD/DPG/orig/CMSSW_14_0_0_pre2/mywork/20807.0_SingleMuPt10+2026D88/step3.root'
...
# -- Re-run mtdTruthProducer because I changed the uniqueId definition
#from SimGeneral.MixingModule.mtdTruthProducer_cfi import *
#process.mtdTruthProducer = mtdTruth.clone()
...
process.out = cms.OutputModule("PoolOutputModule", 
    ...
    fileName = cms.untracked.string('OutputWithAssociationMaps_SingleMu_noPU_new_geomV1.root')
