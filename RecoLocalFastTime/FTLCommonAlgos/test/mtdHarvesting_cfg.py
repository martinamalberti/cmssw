...
process.load("Validation.MtdValidation.btlLocalRecoSoAPostProcessor_cfi")

process.harvesting = cms.Sequence(process.btlSimHitsPostProcessor + process.btlLocalRecoPostProcessor + process.btlLocalRecoPostProcessor )
