...
process.source = cms.Source("PoolSource",
    ...
    #fileNames = cms.untracked.vstring('file:/afs/cern.ch/work/m/malberti/MTD/DPG/CMSSW_14_0_0_pre1/src/SimFastTiming/MtdAssociatorProducers/test/OutputWithAssociationMaps_SingleMu_PU200.root')
    #fileNames = cms.untracked.vstring('file:/afs/cern.ch/work/m/malberti/MTD/DPG/CMSSW_14_0_0_pre1/src/SimFastTiming/MtdAssociatorProducers/test/OutputWithAssociationMaps_SinglePi_noPU.root')
    #fileNames = cms.untracked.vstring('file:/afs/cern.ch/work/m/malberti/MTD/DPG/CMSSW_14_0_0_pre1/src/SimFastTiming/MtdAssociatorProducers/test/OutputWithAssociationMaps_SinglePi_PU200.root')
)
